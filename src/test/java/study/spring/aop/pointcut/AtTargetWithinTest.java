...
public class AtTargetWithinTest {
    ...
    static class AtTargetWithinAspect {
        ...
        @Around("execution(* study.spring.aop..*(..)) && @target(study.spring.aop.member.annotation.ClassAop)")
        ...
        @Around("execution(* study.spring.aop..*(..)) && @within(study.spring.aop.member.annotation.ClassAop)")
